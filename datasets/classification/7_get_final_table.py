...
merged_volumes['volume_pz'] = merged_volumes['volume_pz'].where(merged_volumes['volume_pz_manual'].isna(), merged_volumes['volume_pz_manual'])
merged_volumes['volume_tz'] = merged_volumes['volume_tz'].where(merged_volumes['volume_tz_manual'].isna(), merged_volumes['volume_tz_manual'])
